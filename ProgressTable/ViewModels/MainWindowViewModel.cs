...
using MonitoringProgress.Models;
using ReactiveUI;
using System;
...
namespace MonitoringProgress.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            {
                new Student{Name="Иванов Андрей Алексеевич", Visual=0, Architecture=0, Networks=0, Calculate_Math=0, PI=0, Math=0, Electric=0},
                new Student{Name="Петров Петр Петрович", Visual=2, Architecture=2, Networks=2, Calculate_Math=2, PI=2, Math=2, Electric=2},
            };
            CheckAverage(students);
